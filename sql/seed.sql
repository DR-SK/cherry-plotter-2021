...
VALUES ('Dr. Chem', 'I am a Chemistry doctor', 'Hello, am doctor, dont stab with high heel pls', '{attack, hack, investigate}', 5, 10, 1),
       ('Security Sentry', 'Wears rabbit hat', '!BANG!BANG!', '{attack, hack, investigate}', 5, 5, 1);
COMMIT;
